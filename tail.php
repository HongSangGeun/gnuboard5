...
.btn-mobile:hover{ background:#4338ca; }
</style>
<div id="ft">
...
<div class="logo"><img src="<?= G5_URL ?>/img/logo_gray.svg" style="width: 190px; height: auto; padding-bottom: 7px" alt="경상남도 스마트시티 데이터포털 로고 이미지"></div>
		<p class="ft_info">
