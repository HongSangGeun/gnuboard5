package com.gnuboard.springboard.api;
...
public class EditorUploadController {
    ...
    public EditorUploadController(G5Properties properties) {
    ...
    public Map<String, Object> uploadImage(
        ...
        try {
            ...
            target.transferTo(ckeditorDir.resolve(storedName).toFile());
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public Map<String, Object> uploadCheditorImage(
        ...
        try {
            ...
            file.transferTo(cheditorDir.resolve(storedName).toFile());
        } catch (IOException e) {
            e.printStackTrace();
            return cheditorError();
        }
