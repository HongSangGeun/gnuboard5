...
CREATE TABLE IF NOT EXISTS `g5_board_file` (
  ...
  `bf_datetime` datetime default CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `g5_board_good` (
  ...
  `bg_datetime` datetime default CURRENT_TIMESTAMP,
  PRIMARY KEY  (`bg_id`),
...
CREATE TABLE IF NOT EXISTS `g5_board_new` (
  ...
  `bn_datetime` datetime default CURRENT_TIMESTAMP,
  `mb_id` varchar(20) NOT NULL default '',
  PRIMARY KEY  (`bn_id`),
  KEY `mb_id` (`mb_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `g5_config` (
  ...
  `cf_filter` text NOT NULL DEFAULT '',
  `cf_possible_ip` text NOT NULL DEFAULT '',
  `cf_intercept_ip` text NOT NULL DEFAULT '',
  `cf_analytics` text NOT NULL DEFAULT '',
  `cf_add_meta` text NOT NULL DEFAULT '',
  ...
  `cf_prohibit_id` text NOT NULL DEFAULT '',
  `cf_prohibit_email` text NOT NULL DEFAULT '',
  `cf_new_del` int(11) NOT NULL DEFAULT '0',
  `cf_memo_del` int(11) NOT NULL DEFAULT '0',
  `cf_visit_del` int(11) NOT NULL DEFAULT '0',
  `cf_popular_del` int(11) NOT NULL DEFAULT '0',
  `cf_optimize_date` date default NULL,
  ...
  `cf_stipulation` text NOT NULL DEFAULT '',
  `cf_privacy` text NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `g5_member_cert_history` (
  ...
  `ch_datetime` datetime default CURRENT_TIMESTAMP,
  PRIMARY KEY (`ch_id`),
  KEY `mb_id` (`mb_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `g5_group_member` (
  ...
  `gr_id` varchar(255) NOT NULL default '',
  `mb_id` varchar(20) NOT NULL default '',
  `gm_datetime` datetime default CURRENT_TIMESTAMP,
  PRIMARY KEY  (`gm_id`),
  KEY `gr_id` (`gr_id`),
  KEY `mb_id` (`mb_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `g5_mail` (
  ...
  `ma_time` datetime default CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `g5_member` (
  ...
  `mb_signature` text NOT NULL DEFAULT '',
  `mb_recommend` varchar(255) NOT NULL default '',
  `mb_point` int(11) NOT NULL default '0',
  `mb_today_login` datetime default CURRENT_TIMESTAMP,
  `mb_login_ip` varchar(255) NOT NULL default '',
  `mb_datetime` datetime default CURRENT_TIMESTAMP,
  `mb_ip` varchar(255) NOT NULL default '',
  `mb_leave_date` varchar(8) NOT NULL default '',
  `mb_intercept_date` varchar(8) NOT NULL default '',
  `mb_email_certify` datetime default CURRENT_TIMESTAMP,
  ...
  `mb_profile` text NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `g5_memo` (
  ...
  `me_send_datetime` datetime default CURRENT_TIMESTAMP,
  `me_read_datetime` datetime default CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `g5_point` (
  ...
  `po_expire_date` date default NULL,
...
CREATE TABLE IF NOT EXISTS `g5_scrap` (
  ...
  `ms_datetime` datetime default CURRENT_TIMESTAMP,
  PRIMARY KEY  (`ms_id`),
  KEY `mb_id` (`mb_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8;
