...
CREATE TABLE IF NOT EXISTS `g5_board` (
  ...
  `bo_content_head` text NULL,
  `bo_mobile_content_head` text NULL,
  `bo_content_tail` text NULL,
  `bo_mobile_content_tail` text NULL,
  `bo_insert_content` text NULL,
...
CREATE TABLE IF NOT EXISTS `g5_config` (
  ...
  `cf_filter` text NULL,
  `cf_possible_ip` text NULL,
  `cf_intercept_ip` text NULL,
  `cf_analytics` text NULL,
  `cf_add_meta` text NULL,
  ...
  `cf_prohibit_id` text NULL,
  `cf_prohibit_email` text NULL,
  `cf_new_del` int(11) NOT NULL DEFAULT '0',
  `cf_memo_del` int(11) NOT NULL DEFAULT '0',
  `cf_visit_del` int(11) NOT NULL DEFAULT '0',
  `cf_popular_del` int(11) NOT NULL DEFAULT '0',
  `cf_optimize_date` date NULL,
  ...
  `cf_stipulation` text NULL,
  `cf_privacy` text NULL,
  ...
  `cf_facebook_appid` varchar(100) NOT NULL DEFAULT '',
  `cf_facebook_secret` varchar(100) NOT NULL DEFAULT '',
  `cf_twitter_key` varchar(100) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `g5_login` (
  ...
  `mb_id` varchar(20) NOT NULL default '',
  `lo_datetime` datetime NULL,
  `lo_location` text NULL,
  `lo_url` text NULL,
  PRIMARY KEY (`lo_id`),
...
CREATE TABLE IF NOT EXISTS `g5_mail` (
  ...
  `ma_content` mediumtext NULL,
  `ma_time` datetime NULL,
  `ma_ip` varchar(255) NOT NULL default '',
  `ma_last_option` text NULL,
  PRIMARY KEY  (`ma_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `g5_memo` (
  ...
  `me_send_datetime` datetime NULL,
  `me_read_datetime` datetime NULL,
  `me_memo` text NULL,
...
CREATE TABLE IF NOT EXISTS `g5_qa_config` (
  ...
  `qa_insert_content` text NULL,
  `qa_include_head` varchar(255) NOT NULL DEFAULT '',
  `qa_include_tail` varchar(255) NOT NULL DEFAULT '',
  `qa_content_head` text NULL,
  `qa_content_tail` text NULL,
  `qa_mobile_content_head` text NULL,
  `qa_mobile_content_tail` text NULL,
...
CREATE TABLE IF NOT EXISTS `g5_faq` (
  ...
  `fa_subject` text NULL,
  `fa_content` text NULL,
...
CREATE TABLE IF NOT EXISTS `g5_new_win` (
  ...
  `nw_subject` text NULL,
  `nw_content` text NULL,
